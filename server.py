#!/usr/bin/env python3
"""
AWS Trivia Game Server
Handles multiple client connections and manages the game flow
"""
...
class TriviaServer:
    ...
    def __init__(self):
        ...
        self.answered_current_question = set()  # Set of clients who answered the current question
    ...
    def start(self):
        ...
        try:
            ...
            self.game_questions = random.sample(questions, len(questions))
    ...
    def handle_client(self, client_socket, addr):
        ...
        try:
            ...
            if message["type"] == "join":
                ...
                self.broadcaster.add_client(client_socket, nickname)
                ...
                while True:
                    ...
                    if message["type"] == "start_game" and self.broadcaster.get_player_count() >= 1:
            ...
            if nickname:
                ...
                self.broadcaster.broadcast({
                    "type": "player_left",
                    "nickname": nickname,
                    "player_count": self.broadcaster.get_player_count() - 1
                })
